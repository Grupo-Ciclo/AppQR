...
import Grid from '../../components/Grids/Usuario';
...
export default function Usuario() {
  ...
  async function loadData() {
    ...
    try {
      const response = await api.get(`QR/bd/lixeira/listar.php?pagina=${page}&limite=10`);
  ...
  return (
    ...
    <View style={styles.container}>
      {/* <Header title="Lista de Lixeira"></Header> */}
